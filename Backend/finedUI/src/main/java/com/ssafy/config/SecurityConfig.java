...
import com.ssafy.common.jwt.JwtTokenAuthenticationFilter;
...
//                .antMatchers("/**").permitAll()
                .antMatchers("/api/user/login").permitAll() //authenticated 테스트 403 에러 반환 확인.
...
//                oAuth 접근 url permitall
                .and()
                .authorizeRequests()
                .antMatchers("/oauth2/**").permitAll()

//                security의 oAuth2를 사용하겠다.
//                .and()
//                .oauth2Login()
